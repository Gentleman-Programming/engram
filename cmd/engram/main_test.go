...
func TestPrintUsage(t *testing.T) {
	...
	for _, agent := range []string{"opencode", "opencode-v2", "pi", "claude-code", "gemini-cli", "codex", "antigravity-cli", "windsurf", "qwen", "kiro", "cursor", "vscode-copilot", "kilocode", "kimi", "commandcode"} {
