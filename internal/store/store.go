...
// projectObservationSet preserves the legacy ownership rescue without applying
// functions to indexed project columns. The direct branch finds owned rows; the
// second branch finds only NULL/empty rows through their owning session.
