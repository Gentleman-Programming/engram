...
var runtimeSQLEscapes = map[string]bool{
	...
	"ensureFTSTrigramTables":                  true,
	"recreateObservationFTSTriggersTx":        true,
	"recreatePromptFTSTriggersTx":             true,
	"ftsTableSQLTx":                           true,
	"ftsTableHasColumnTx":                     true,
	"finalizeSemanticJudgedRelationTx":        true,
