...
| Pi warns that its runtime session belongs to another project | Pi was reused after moving projects. Prompt and passive capture are suppressed to protect project ownership; start a fresh Pi session in the current project.                                                                                                           |
